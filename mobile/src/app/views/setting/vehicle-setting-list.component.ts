...
@Component({
  selector: 'app-vehicle-setting-list',
  templateUrl: './vehicle-setting-list.component.html',
  styleUrls: ['./vehicle-setting-list.component.css'],
  moduleId: module.id,
})
export class VehicleSettingListComponent implements OnInit {
